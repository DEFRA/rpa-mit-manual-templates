...
const getAllInvoices = async (request) => {
  ...
  return { pageTitle: constant_model.invoice_list_title, invoices: modifyInvoiceResponse(data?.invoices || []), success_message, userName: (request.yar.get('account')?.username || '') }
}
