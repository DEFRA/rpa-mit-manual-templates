...
const adminApproverList = 'Admin Approver List'
const adminApproverAddTitle = 'Add Admin Approver'
const adminApproverEditTitle = 'Edit Admin Approver'
const adminApproverUpdateSuccess = 'Admin Approver Updated Successfully'
const adminApproverCreationSuccess = 'Admin Approver Created Successfully'
const adminApproverDeletionSuccess = 'Admin Approver Deleted Successfully'
...
module.exports = {
  ...
  bulkUploadAr,
  adminApproverList,
  adminApproverAddTitle,
  adminApproverEditTitle,
  adminApproverUpdateSuccess,
  adminApproverCreationSuccess,
  adminApproverDeletionSuccess
}
